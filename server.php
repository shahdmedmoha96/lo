...
// check if username exist
    $user_check = mysqli_query($db, "SELECT username FROM  users WHERE username ='$username'");
...
// check if email exist
    ...
    if (strlen($password_1) <= 3) {
        array_push($errors, "Password must be > 3");
    }
    ...
    if (count($errors) == 0) {
        ...
        $_SESSION['success'] = "Register  is Successfull";
